package com.iqb.programmingbank.exception;
...
public class GlobalExceptionHandler {
    ...
    public BaseResponse<?> notRoleExceptionHandler(RuntimeException e) {
        ...
        return ResultUtils.error(ErrorCode.NO_AUTH_ERROR, "no permission");
    }

    @ExceptionHandler(NotLoginException.class)
    public BaseResponse<?> notLoginExceptionHandler(RuntimeException e) {
        log.error("NotLoginException", e);
        return ResultUtils.error(ErrorCode.NOT_LOGIN_ERROR, "not login");
    }
}

...
import com.iqb.programmingbank.constant.FileConstant;
import com.iqb.programmingbank.exception.BusinessException;
import com.iqb.programmingbank.manager.CosManager;
import com.iqb.programmingbank.model.dto.file.UploadFileRequest;
import com.iqb.programmingbank.model.entity.User;
import com.iqb.programmingbank.model.enums.FileUploadBizEnum;
...
public class FileController {
    ...
    public BaseResponse<String> uploadFile(@RequestPart("file") MultipartFile multipartFile,
        ...
        try {
            ...
            throw new BusinessException(ErrorCode.SYSTEM_ERROR, "upload faild");
        } finally {
            if (file != null) {
                // 删除临时文件
    ...
    private void validFile(MultipartFile multipartFile, FileUploadBizEnum fileUploadBizEnum) {
        ...
        if (FileUploadBizEnum.USER_AVATAR.equals(fileUploadBizEnum)) {
            if (fileSize > ONE_M) {
                throw new BusinessException(ErrorCode.PARAMS_ERROR, "file size cannot exceed 1M");
            }
